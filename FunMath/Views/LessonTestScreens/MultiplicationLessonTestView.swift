...
struct MultiplicationLessonTestView: View {
    @State private var firstNumber: Int = Int.random(in: 10...99)
...
struct MultiplicationLessonTestView_Previews: PreviewProvider {
    static var previews: some View {
        MultiplicationLessonTestView()
    }
}
